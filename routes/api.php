...
Route::middleware('auth:api')->group(function () {
    ...
    // API Bakul
    Route::resource('dashboard', 'API\App\DashboardAPIController');
    Route::resource('shop', 'API\App\ShopsController');
    Route::post('shop/{id}', 'API\App\ShopsController@update');
    Route::resource('order', 'API\App\OrdersController');
    Route::resource('product', 'API\App\ProductsController');
    Route::post('product/{id}', 'API\App\ProductsController@update');

    // API Payment
    Route::post('createVA', 'API\VA\VABTNController@createVA');
    Route::post('inquiryVA', 'API\VA\VABTNController@inquiryVA');
    Route::post('deleteVA', 'API\VA\VABTNController@deleteVA');
    Route::post('updateVA', 'API\VA\VABTNController@updateVA');
    Route::get('reportVA', 'API\VA\VABTNController@reportVA');
});
Route::get('shopcategory', 'API\App\ShopCategoryController@index');
Route::resource('banners', 'API\BannerAPIController');
Route::get('popup/{id}', 'API\BannerAPIController@popUp');
