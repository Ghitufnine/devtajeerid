    ...
    <li class="nav-item has-treeview {{ Request::is('drivers*') || Request::is('earnings*') || Request::is('driversPayouts*') || Request::is('restaurantsPayouts*') || Request::is('payments*') ? 'menu-open' : '' }}">
        ...
        <ul class="nav nav-treeview">
            ...
            @can('restaurantsPayouts.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('restaurantsPayouts*') ? 'active' : '' }}" href="{!! route('restaurantsPayouts.index') !!}">@if($icons)<i class="nav-icon fa fa-dollar"></i>@endif<p>{{trans('lang.restaurants_payout_plural')}}</p></a>
                </li>
            @endcan
