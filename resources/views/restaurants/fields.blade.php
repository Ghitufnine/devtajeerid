...
<!-- Shop Category Id Field -->
    <div class="form-group row">
        {!! Form::label('shop_category_id', trans("lang.shop_category_id"),['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::select('shop_category_id', $category, null, ['class' => 'select2 form-control']) !!}
