...
<div class="form-group row col-md-6 col-sm-12">
  ...
  <div class="col-9">
    <a href="http://wa.me/62{!! $order->user->phone !!}"></a><p>{!! isset($order->user->custom_fields['phone']) ? $order->user->custom_fields['phone']['view'] : "" !!}</p>
  </div>

  {!! Form::label('delivery_address', trans('lang.delivery_address'), ['class' => 'col-3 control-label']) !!}
  <div class="col-9">
   <a href="http://www.google.com/maps/place/{!! $order->deliveryAddress->latitude !!},{!! $order->deliveryAddress->longitude !!}"><p>{!! $order->deliveryAddress ? $order->deliveryAddress->address : '' !!}</p></a>
  </div>
