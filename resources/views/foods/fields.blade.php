...
<div class="form-group row ">
  ...
  <div class="col-9">
    {!! Form::number('price', null,  ['class' => 'form-control','placeholder'=>  trans("lang.food_price_placeholder"),'step'=>"0.01", 'min'=>"0"]) !!}
    <div class="form-text text-muted">
...
<div class="form-group row ">
  ...
  <div class="col-9">
    {!! Form::number('discount_price', null,  ['class' => 'form-control','placeholder'=>  trans("lang.food_discount_price_placeholder"),'step'=>"0.01", 'min'=>"0"]) !!}
    <div class="form-text text-muted">
