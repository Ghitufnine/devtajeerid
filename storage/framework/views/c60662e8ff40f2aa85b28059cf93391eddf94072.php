...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark"><?php echo e(trans('lang.notification_plural')); ?> <small><?php echo e(trans('lang.notification_desc')); ?></small></h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/dev.tajeer.id/devtajeer/resources/views/notifications/index.blade.php ENDPATH**/ ?>