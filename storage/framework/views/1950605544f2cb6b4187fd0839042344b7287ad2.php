...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            <?php echo Form::select('driver_id', $driver, null, ['class' => 'select2 form-control']); ?>
...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            <?php echo Form::number('delivery_fee', null,  ['class' => 'form-control','placeholder'=>  trans("lang.order_delivery_fee_placeholder")]); ?>
...
<?php /**PATH /home/admin/dev.tajeer.id/devtajeer/resources/views/orders/fields.blade.php ENDPATH**/ ?>