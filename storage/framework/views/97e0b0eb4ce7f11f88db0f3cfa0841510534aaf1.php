...
<script type="text/javascript">
    function initICheck(){
        $('input[type="checkbox"].permission').on('ifCreated', function (event) {
            ...
            $.ajax({
                method: "GET",
                url: "<?php echo e(url('permissions/role-has-permission')); ?>",
        ...
        $('input[type="checkbox"].permission').on('ifClicked', function (event) {
            ...
            $.ajax({
                method: "POST",
                url: url,
                data: {_token: "<?php echo e(csrf_token()); ?>", roleId: roleId, permission: permission}
            })
                .done(function (msg) {
    ...
    function renderButtons(tableId) {
        ...
        $("#" + tableId + "_filter").html("<div class=\"input-group input-group-sm\">\n" +
            "  <input type=\"text\" class=\"form-control\" placeholder=\"<?php echo e(trans('lang.search')); ?>\" aria-label=\"<?php echo e(trans('lang.search')); ?>\">\n" +
...
<?php /**PATH C:\Users\Ghani\Downloads\Compressed\devtajeer-master\devtajeer-master\resources\views/layouts/datatables_js.blade.php ENDPATH**/ ?>