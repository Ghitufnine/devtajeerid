...
<?php $__env->stopPush(); ?>
<?php $__env->startSection('settings_title',trans('lang.role_create')); ?>
    ...
    <div class="card">
        <div class="card-header">
            <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<?php echo route('roles.create'); ?>"><i class="fa fa-plus mr-2"></i><?php echo e(trans('lang.role_create')); ?></a>
                </li>
            </ul>
        </div>
        <div class="card-body">
...
<?php echo $__env->make('layouts.settings.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/dev.tajeer.id/devtajeer/resources/views/settings/roles/create.blade.php ENDPATH**/ ?>