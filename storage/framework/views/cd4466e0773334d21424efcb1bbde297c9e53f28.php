...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark"><?php echo e(trans('lang.restaurant_plural')); ?> <small><?php echo e(trans('lang.restaurant_desc')); ?></small></h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="<?php echo route('restaurants.index'); ?>"><?php echo e(trans('lang.restaurant_plural')); ?></a>
          </li>
          <li class="breadcrumb-item active"><?php echo e(trans('lang.restaurant_edit')); ?></li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <?php endif; ?>
        <li class="nav-item">
          <a class="nav-link active" href="<?php echo url()->current(); ?>"><i class="fa fa-pencil mr-2"></i><?php echo e(trans('lang.restaurant_edit')); ?></a>
        </li>
      </ul>
    </div>
    <div class="card-body">
      <?php echo Form::model($restaurant, ['route' => ['restaurants.update', $restaurant->id], 'method' => 'patch']); ?>

      <div class="row">
        <?php echo $__env->make('restaurants.fields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      </div>
      <?php echo Form::close(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Ghani\Downloads\Compressed\devtajeer-master\devtajeer-master\resources\views/restaurants/edit.blade.php ENDPATH**/ ?>