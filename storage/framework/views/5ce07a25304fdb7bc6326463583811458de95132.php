...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark"><?php echo e(trans('lang.food_plural')); ?> <small><?php echo e(trans('lang.food_desc')); ?></small></h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo route('foods.index'); ?>"><i class="fa fa-list mr-2"></i><?php echo e(trans('lang.food_table')); ?></a>
        </li>
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('foods.create')): ?>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo route('foods.create'); ?>"><i class="fa fa-plus mr-2"></i><?php echo e(trans('lang.food_create')); ?></a>
        </li>
        <?php endif; ?>
        <li class="nav-item">
          <a class="nav-link active" href="<?php echo url()->current(); ?>"><i class="fa fa-pencil mr-2"></i><?php echo e(trans('lang.food_edit')); ?></a>
        </li>
      </ul>
    </div>
    <div class="card-body">
      <?php echo Form::model($food, ['route' => ['foods.update', $food->id], 'method' => 'patch']); ?>

      <div class="row">
        <?php echo $__env->make('foods.fields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      </div>
      <?php echo Form::close(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/dev.tajeer.id/devtajeer/resources/views/foods/edit.blade.php ENDPATH**/ ?>