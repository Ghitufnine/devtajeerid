...
<div class="form-group row ">
  ...
  <div class="col-9">
    <?php echo Form::select('method', ['Bank' => 'Bank','Cache'=>'Cache'], null, ['class' => 'select2 form-control']); ?>
...
<div class="form-group row ">
  ...
  <div class="col-9">
    <?php echo Form::number('amount', null,  ['class' => 'form-control','placeholder'=>  trans("lang.restaurants_payout_amount_placeholder")]); ?>
...
<?php /**PATH /home/admin/dev.tajeer.id/devtajeer/resources/views/restaurants_payouts/fields.blade.php ENDPATH**/ ?>