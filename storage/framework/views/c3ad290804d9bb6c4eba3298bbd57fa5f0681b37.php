...
<!-- Shop Category Id Field -->
    <div class="form-group row">
        <?php echo Form::label('shop_category_id', trans("lang.shop_category_id"),['class' => 'col-3 control-label text-right']); ?>

        <div class="col-9">
            <?php echo Form::select('shop_category_id', $category, null, ['class' => 'select2 form-control']); ?>

            <div class="form-text text-muted">Choose Shop Categories</div>
        </div>
    </div>
</div>
<?php if($customFields): ?>
...
<?php /**PATH C:\Users\Ghani\Downloads\Compressed\devtajeer-master\devtajeer-master\resources\views/restaurants/fields.blade.php ENDPATH**/ ?>