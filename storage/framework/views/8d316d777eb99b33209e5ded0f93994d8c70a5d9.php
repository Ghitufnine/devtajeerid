          ...
          <table class="table">
              <tbody>
                  <tr>
                      <td>Nama Toko</td>
                      <td> : </td>
                      <td><?php echo e($shops->name); ?></td>
                  </tr>
                  <tr>
                    <td>Nomor Penjual</td>
                    <td> : </td>
                    <td><a href="https://api.whatsapp.com/send?phone=<?php echo e($shops->phone); ?>"><?php echo e($shops->phone); ?></a></td>
                </tr>
                  <tr>
                      <td>Alamat Pengambilan</td>
                      <td> : </td>
                    <td>
                        <a href="http://www.google.com/maps/place/<?php echo e($shops->latitude); ?>,<?php echo e($shops->longitude); ?>">
                            <?php echo e($shops->pickup_address); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/dev.tajeer.id/devtajeer/resources/views/orders/show.blade.php ENDPATH**/ ?>