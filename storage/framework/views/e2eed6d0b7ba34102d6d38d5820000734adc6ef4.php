...
<div class="form-group row col-md-6 col-sm-12">
  ...
  <div class="col-9">
    <a href="http://wa.me/62<?php echo $order->user->phone; ?>"></a><p><?php echo isset($order->user->custom_fields['phone']) ? $order->user->custom_fields['phone']['view'] : ""; ?></p>
  </div>

  <?php echo Form::label('delivery_address', trans('lang.delivery_address'), ['class' => 'col-3 control-label']); ?>

  <div class="col-9">
   <a href="http://www.google.com/maps/place/<?php echo $order->deliveryAddress->latitude; ?>,<?php echo $order->deliveryAddress->longitude; ?>"><p><?php echo $order->deliveryAddress ? $order->deliveryAddress->address : ''; ?></p></a>
  </div>
...
<?php /**PATH /home/admin/dev.tajeer.id/devtajeer/resources/views/orders/show_fields.blade.php ENDPATH**/ ?>